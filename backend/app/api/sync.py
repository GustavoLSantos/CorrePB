...
@router.get(
    "/sync-bucket/status",
    summary="Status da sincronização com bucket",
...
@router.post(
    "/sync-bucket",
    summary="Sincronizar eventos para o bucket S3",
    responses={401: {"model": ErrorResponse}, 409: {"model": ErrorResponse}, 500: {"model": ErrorResponse}},
)
